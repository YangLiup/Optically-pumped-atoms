...
cxx= Omega**2*bz**2/(4*gammap*(gammap**2+Omega**2))
cxy= cxx*gammap/Omega
Lorentzianpp = gammap / (gammap**2 + (omega - Omega) ** 2)/2/np.pi
Lorentzianpn = gammap / (gammap**2 + (omega + Omega) ** 2)/2/np.pi
Lorentzianppd =(omega-Omega) / (gamman**2 + (omega - Omega) ** 2)/2/np.pi
Lorentzianpnd = (omega-Omega) / (gamman**2 + (omega + Omega) ** 2)/2/np.pi

Lorentzianpp0 = gammap / (gammap**2 )/2/np.pi
Lorentzianpn0 = gammap / (gammap**2 + (2*Omega) ** 2)/2/np.pi
Lorentzianppd0 =0
Lorentzianpnd0 = (omega-Omega) / (gamman**2 + (2* Omega) ** 2)/2/np.pi
...
with plt.style.context(['science','nature']):
    ...
    p1, = plt.plot(omega, (cxx*(Lorentzianpp + Lorentzianpn)+cxy*(Lorentzianpnd - Lorentzianppd))/(cxx*(Lorentzianpp0 + Lorentzianpn0)+cxy*(Lorentzianpnd0 - Lorentzianppd0)),linewidth=2)
    p2, = plt.plot(omega, (cxx*(Lorentzianpp + Lorentzianpn))/(cxx*(Lorentzianpp0 + Lorentzianpn0)+cxy*(Lorentzianpnd0 - Lorentzianppd0)))
    p3, = plt.plot(omega, (cxy*(Lorentzianpnd - Lorentzianppd))/(cxx*(Lorentzianpp0 + Lorentzianpn0)+cxy*(Lorentzianpnd0 - Lorentzianppd0)))
