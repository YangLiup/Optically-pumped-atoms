...
with plt.style.context(['science','nature']):
    ...
    # ax1.plot([],[])
    # ax1.plot([],[])
    p1,=ax1.plot(delta_nva2,chip(delta_nva2,0)/np.max(chip(delta_nva2,0)),linewidth=0.8)
    p2,=ax1.plot(delta_nva2,chim(delta_nva2,0)/np.max(chip(delta_nva2,0)),linewidth=0.8)
    ...
    # ax2.plot([],[])
    # ax2.plot([],[])
    ax2.plot(delta_nva2,chip(delta_nva2,0.5)/np.max(chip(delta_nva2,0)),linewidth=0.8)
    ax2.plot(delta_nva2,chim(delta_nva2,0.5)/np.max(chip(delta_nva2,0)),linewidth=0.8)
    ...
    # ax3.plot([],[])
    # ax3.plot([],[])
    ax3.plot(delta_nva2,chip(delta_nva2,0.99)/np.max(chip(delta_nva2,0)),linewidth=0.8)
    ax3.plot(delta_nva2,chim(delta_nva2,0.99)/np.max(chip(delta_nva2,0)),linewidth=0.8)
