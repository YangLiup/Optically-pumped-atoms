...
with plt.style.context(['science','nature']):
    ...
    ax4.plot(PP1,(fp1/DD1-z/fm1)/(fp1/DD1+z/fm1))
    ax4.plot(PP2,(fp2/DD2-zz/fm2)/(fp2/DD2+zz/fm2))
    ax4.plot(PP3,(fp3/DD3-zzz/fm3)/(fp3/DD3+zzz/fm3))
    # ax4.plot(PP3,-fp3*fm3/DD3/zzz*0+1,linestyle='dotted')
    ax4.set_xlim([0.,0.99])
    ax4.set_ylim([0.,0.002])
    # ax4.set_ylim([-0.1,0.1])
    ax4.set_ylabel('$\\varepsilon$', fontsize=10)
    ...
    ax3.set_xlim([0.,0.99])
    # ax4.set_ylim([-0.1,0.1])
    ax3.set_ylabel('$\kappa(P)$', fontsize=10)
    ...
    ax2.text(0.45,0.928, '(b)',fontsize=8)
