...
def rate(I):
    ...
    for P in P_range:
        ...
        popt_1, pcov = curve_fit(func, t[round(len(t)/2):-1], np.real(y1[round(len(y1)/2):-1]))
        # y2=func(t, *popt_1)
...
GammaP3=rate(7/2)
plt.figure()
p1,=plt.plot(P_range,GammaP1)
p2,=plt.plot(P_range,GammaP2)
p3,=plt.plot(P_range,GammaP3)
