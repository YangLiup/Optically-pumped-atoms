...
def fun(X):
    global c,nuK_D1,nuRb_D1,Gamma_DK,Gamma_DRb,Gamma_SDK,Gamma_DRb,delta_Bsp, Delta_nuK,Delta_nuRb,delta_Bph ,re,ODK,ODRb,PK0,PRb0
...
#--------------------稳态极化------------------------#
    ...
    PRb0=(Rse_Rb+Gamma_pr+Gamma_SDK+Gamma_DK)*Rop/((Rse_Rb+Gamma_pr+Gamma_SDK+Gamma_DK)*(Rop+Rse_K+Gamma_SDRb+Gamma_DRb)-Rse_Rb*Rse_K)
