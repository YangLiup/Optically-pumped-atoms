...
with plt.style.context(['science']):
    ...
    ax4.set_ylabel('$\\varepsilon$', fontsize=9)
    ...
    ax4.text(0.9, 0.00175, '(d)', fontsize=9)

    ax3 = fig.add_subplot(223)
    pp,=ax3.plot(PP1,fp1/DD1)
    pp2,=ax3.plot(PP2,fp2/DD2)
    pp3,=ax3.plot(PP3,fp3/DD3)
    ax3.set_ylabel('$\\tilde{\kappa}^+$', fontsize=9)
    ax3.tick_params(axis='x', labelsize='9' )
    ax3.tick_params(axis='y', labelsize='9' )
    ax3.text(0.9, 0.2, '(c)', fontsize=9)
    ax3.set_xlim([0.,1])
    ax3.set_xlabel('$P$')
    ...
    ax1.text(0.9, 0.0425, '(a)', fontsize=9)
    ax1.set_xlim([0.003,1])
    # ax3.set_ylim([0,0.1])

    ax1.set_ylabel('$\\tilde{\Gamma}^+_{\perp}$ $(\omega_e^2/R_{\\rm{se}})$', fontsize=9)
    ...
    ax2.set_ylabel('$\\tilde{\Gamma}_{\perp}^- $ ($R_{\\rm{se}}$) ', fontsize=9)
    ax2.tick_params(axis='x', labelsize='9' )
    ax2.tick_params(axis='y', labelsize='9' )
    ax2.text(0.9,0.915, '(b)', fontsize=9)
