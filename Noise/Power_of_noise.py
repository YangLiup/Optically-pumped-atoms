...
with plt.style.context(['science','nature']):
    ...
    ax_1.loglog(omega, (chim(100)**2*Fxn2*(Lorentziannp + Lorentziannn))/np.max((chim(-100)**2*Fxn2*(Lorentziannp + Lorentziannn)+chip(-100)**2*Fx2*(Lorentzianpp + Lorentzianpn))))
    ax_1.set_xlabel('$\\nu$ (Hz)', fontsize=9)
